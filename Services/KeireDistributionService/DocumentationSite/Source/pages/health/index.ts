...
export const GET: APIRoute = async (context) => {
    ...
    return apiResponse(context, { status: degraded ? "degraded" : "healthy", service: "keire-web", version: "0.4.3", releaseState: "preparing", targetCatalogVersion: "0.4.3", catalogState: "preparing", activeCatalogVersion: "0.4.2", checks, correlationId: context.locals.correlationId }, degraded ? 503 : 200, "no-store");
};
