...
export const GET: APIRoute = async (context) => {
    ...
    return apiResponse(context, { status: degraded ? "degraded" : "healthy", service: "keire-web", version: "0.4.4", releaseState: "current", targetCatalogVersion: "0.4.4", catalogState: "active", activeCatalogVersion: "0.4.4", checks, correlationId: context.locals.correlationId }, degraded ? 503 : 200, "no-store");
};
