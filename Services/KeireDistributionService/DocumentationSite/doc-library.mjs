...
export const docGroups = [
    ...
    group("Kéire 0.4.0 user manual", "open-book", [
        ...
        "Manual/ScriptingFundamentals.md",
        "Manual/ScriptingRecipes.md",
        "Manual/WorldAndAssets.md",
        "Manual/InputPhysicsAndAudio.md",
        "Manual/UiJobsAndDiagnostics.md",
        "Manual/ShaderGraph.md",
        "Manual/ShaderGraphExamples.md",
        "Manual/MaterialGraph.md",
        "Manual/MaterialGraphExamples.md",
        "Manual/VfxGraph.md",
        "Manual/VfxGraphExamples.md",
        "Manual/GraphEditing.md",
        "Manual/DebuggingAndProfiling.md",
        "Manual/PlayerBuildsAndPackages.md",
        "Manual/CSharpApiQuickReference.md",
    ]),
    ...
    group("Assets, rendering, and builds", "layers", [
        ...
        "BuiltinMeshes.md",
        "Rendering.md",
        "GpuOcclusionCoveragePlan.md",
        "ShadersAndMaterials.md",
        "MaterialGraphShaderIntegrationPlan.md",
    ...
    group("C# scripting", "seti:c-sharp", [
        ...
        "Scripting/RenderingAndMaterials.md",
        "Scripting/ScenesAndRenderSettings.md",
        "Scripting/ManagedExtensibility.md",
...
export const docAuthorities = {
    ...
    "Manual/README.md": ["Config/Project.conf", "KeireManaged/RuntimeApi.cs"],
    "Manual/ProjectsAndEditor.md": ["KeireHub/Source/HubProductUi.cpp", "KeireClient/Include/KeireClient/Editor/EditorPanels.h"],
    "Manual/VisualWorkflowMaps.md": ["KeireManaged/Behaviour.cs", "KeireCore/Include/Keire/Build/PlayerBuild.h"],
    "Manual/ScriptingFundamentals.md": ["KeireManaged/Behaviour.cs", "KeireManaged/SerializationAttributes.cs"],
    ...
    "Manual/MaterialGraphExamples.md": ["KeireCore/Include/Keire/Rendering/MaterialGraph.h", "KeireManaged/Rendering.cs"],
    "Manual/VfxGraph.md": ["KeireCore/Include/Keire/Vfx/VfxSystem.h", "KeireManaged/RuntimeApi.cs"],
    "Manual/VfxGraphExamples.md": ["KeireCore/Include/Keire/Vfx/VfxSystem.h", "Docs/Vfx.md"],
    "Manual/GraphEditing.md": ["KeireCore/Include/Keire/Authoring/GraphAuthoring.h", "KeireClient/Include/KeireClient/Editor/GraphClipboard.h"],
    "Manual/DebuggingAndProfiling.md": ["KeireCore/Include/Keire/Diagnostics/Profiler.h", "KeireManaged/Profiler.cs"],
    "Manual/PlayerBuildsAndPackages.md": ["KeireCore/Include/Keire/Build/PlayerBuild.h", "KeireCore/Include/Keire/Assets/AssetPackage.h"],
    "Manual/CSharpApiQuickReference.md": ["KeireManaged", "KeireManaged.Tests"],
    ...
    "UiStyleStudio.md": ["KeireClient/Source/Editor/UiStyleSourceEditor.cpp", "KeireClient/Source/Editor/UiBuilderPanelStyles.cpp"],
    ...
    "GpuOcclusionCoveragePlan.md": ["KeireCore/Source/Rendering/RenderOcclusion.cpp", "KeireTests/Source/Rendering/GpuVisibilityOwnershipTests.cpp"],
    "ShadersAndMaterials.md": ["KeireCore/Include/Keire/Rendering/ShaderGraph.h", "KeireClient/Source/Editor/ShaderGraphPanel.cpp"],
    "MaterialGraphShaderIntegrationPlan.md": ["KeireCore/Include/Keire/Rendering/MaterialGraph.h", "KeireCore/Source/Rendering/MaterialGraph.cpp"],
    ...
    "Scripting/ManagedExtensibility.md": ["KeireManaged/RuntimeServices.cs", "KeireManaged/NativeServiceContracts.cs"],
    ...
    "DiagnosticBundles.md": ["KeireCore/Include/KeireInternal/Diagnostics/DiagnosticBundleInternal.h", "KeireTests/Source/Diagnostics/DiagnosticBundleTests.cpp"],
