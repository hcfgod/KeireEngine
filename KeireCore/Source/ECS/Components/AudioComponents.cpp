    ...
    ComponentRegistration CreateAudioSourceComponentRegistration()
    {
        ...
        result.Properties = {
            {"clip",
             ...
             "Audio played by this source. Drag an imported Audio Clip here."},
            {"mixer",
             "Mixer",
             "Mixing",
             ComponentPropertyKind::Asset,
             ...
             "Optional routing override. Leave empty to use the project's Default Mixer."},
            {"busId",
             "Stable Bus ID",
             "Mixing",
            ...
            {"bus",
             ...
             0.1,
             {},
             "Legacy name fallback used when no stable bus ID is assigned."},
            {"gain",
             "Gain",
             "Mixing",
             ...
             0.01,
             {},
             "Source volume. The Inspector displays this linear value in decibels."},
            {"pitch",
             "Pitch",
             "Mixing",
             ComponentPropertyKind::Scalar,
             ...
             0.01,
             {},
             "Playback speed and pitch multiplier. 1.0 preserves the imported clip."},
            {"priority",
             "Priority",
             "Mixing",
             ...
             1.0,
             {},
             "Voice-stealing priority. Higher values remain audible before lower-priority sources."},
            {"minimumDistance",
             "Minimum Distance",
             "Spatial",
             ComponentPropertyKind::Scalar,
             ...
             0.1,
             {},
             "Distance inside which a spatial source plays at full authored volume."},
            {"maximumDistance",
             "Maximum Distance",
             "Spatial",
             ComponentPropertyKind::Scalar,
             ...
             0.1,
             {},
             "Distance at which the spatial source reaches the end of its attenuation curve."},
            {"attenuation",
             "Attenuation Curve",
             "Spatial",
            ...
            {"spatial",
             ...
             0.1,
             {},
             "Uses the active Audio Listener (or the primary Camera fallback) for distance and speaker panning."},
            {"loop",
             "Loop",
             "Playback",
             ComponentPropertyKind::Boolean,
             ...
             0.1,
             {},
             "Restarts the clip when it reaches the end."},
            {"playOnAwake",
             "Play On Awake",
             "Playback",
             ComponentPropertyKind::Boolean,
             ...
             0.1,
             {},
             "Starts automatically when Play Mode begins and the source becomes active."},
        };
    ...
    ComponentRegistration CreateAudioReverbZoneComponentRegistration()
    {
        ...
        result.Properties = {
            {"mixer",
             ...
             0.1,
             AudioMixerAsset::StaticType(),
             "Optional routing override. Leave empty to affect the project's Default Mixer."},
            {"snapshotId",
             "Snapshot Stable ID",
             "Reverb",
             ComponentPropertyKind::Text,
            ...
            {"shape",
             ...
             1.0,
             {},
             "Box and Sphere volumes respect the entity's full world transform, including rotation and scale."},
            {"boxHalfExtent",
             "Box Half Extent",
             "Volume",
             ComponentPropertyKind::Vector3,
             false,
             {},
             {},
             0.1,
             {},
             "Local-space half size of a Box reverb volume."},
            {"sphereRadius",
             "Sphere Radius",
             "Volume",
             ComponentPropertyKind::Scalar,
             ...
             0.1,
             {},
             "Local-space radius of a Sphere reverb volume."},
            {"priority",
             "Priority",
             "Blending",
             ComponentPropertyKind::Integer,
             ...
             1.0,
             {},
             "When zones overlap on one mixer, the higher-priority zone controls the blend."},
            {"blendDistance",
             "Blend Distance",
             "Blending",
             ComponentPropertyKind::Scalar,
             ...
             0.1,
             {},
             "World-space fade distance outside the volume. Zero creates a hard boundary."},
            {"reverbSend",
             "Reverb Send",
             "Blending",
             ComponentPropertyKind::Scalar,
             ...
             0.01,
             {},
             "Maximum reverb contribution at the center of the zone."},
        };
    ...
    ComponentRegistration CreateAudioListenerComponentRegistration()
    {
        ...
        result.Properties = {
            {"primary",
             ...
             0.1,
             {},
             "The first active primary listener drives spatial audio. Without one, the primary Camera is used."},
            {"gain",
             "Gain",
             "Listener",
             ComponentPropertyKind::Scalar,
             ...
             0.01,
             {},
             "Final listener volume. The Inspector displays this linear value in decibels."},
        };
