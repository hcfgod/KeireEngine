...
Material schema version 3 has these authoritative fields:
...
Phase 1 adds schema v3, dual-read support, stable property IDs, and compiler diagnostics. New materials use v3.
