...
Kéire 0.4.2 signed catalog sequence 17 is active for Windows and Linux x86-64 and retains the immutable 0.4.1 records.
A local build or quarantine package is still not a downloadable release unless it is present in the active catalog.
