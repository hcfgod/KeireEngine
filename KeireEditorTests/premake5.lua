project(ProjectConfig.PROJECT_NAMESPACE .. "EditorTests")
    ...
    files
    {
        ...
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/AnimatorControllerDocument.cpp",
        ...
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/AuthoringGeometry.cpp",
        ...
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/EditorAssetFileService.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/EditorCommandRouter.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/EditorAssetOperationCoordinator.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/EditorBuildCookCoordinator.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/EditorSessionState.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/EditorDocumentWorkspaceCoordinator.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/EditorManagedRuntimeCoordinator.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/EditorPackageCoordinator.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/EditorPlayModeCoordinator.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/EditorReplayProfilingCoordinator.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/EditorRuntimeUiInput.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/EditorWorkspaceLifecycleCoordinator.cpp",
        ...
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/MaterialSelectionEditing.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/MaterialMigrationReview.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/MaterialVariantEditing.cpp",
        ...
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/ShaderGraphDocumentAuthoring.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/ShaderGraphSourceView.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/ShaderGraphBlackboard.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/ShaderCodeTemplate.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/ShaderGraphSaveState.cpp",
        ...
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/ShaderGraphPreviewEvaluationMath.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/ShaderGraphPreviewEvaluator.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/ShaderGraphPreviewSurfaces.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/ShaderGraphPreviewGeometry.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/ShaderGraphPreviewMaterial.cpp",
        ...
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/ManagedDataTypeCache.cpp",
        "../" .. ProjectConfig.CLIENT_DIRECTORY .. "/Source/Editor/ManagedReferenceGraphInspector.cpp",
