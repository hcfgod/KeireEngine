...
SDL headers, its static archive, and its official CMake package are redistributed under `third-party/SDL3`; nlohmann/json headers are not redistributed because no JSON type crosses Kéire's public API.
